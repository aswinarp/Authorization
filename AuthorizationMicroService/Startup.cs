...
namespace AuthorizationMicroService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAuthenticateService>(new AuthenticateService(new AuthenticateRepository()));
            services.AddSingleton<ITokenService>(new TokenService(new TokenRepository()));
        }
